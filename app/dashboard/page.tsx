        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-text-muted">Welcome back, {user?.name}! Manage your tasks efficiently.</p>
            </div>
            <Button
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-surface rounded-lg p-6 border border-border-light shadow-soft">
              ...
              <p className="text-3xl font-bold text-text">{stats.completionRate}%</p>
            </div>
          </div>
              ...
              {showForm && (
                <div className="bg-surface rounded-xl p-6 border border-border-light shadow-md sticky top-4">
                  ...
                  <TodoForm
                    ...
                    initialData={editingId ? todos.find(t => t.id === editingId) : null}
                    isLoading={isSaving}
